...
class Upgrade_Detector implements Integration {
	...
	public function yoast_seo_upgrade_ran() {
		$this->add_notification( \__( 'The Yoast SEO upgrade routine was executed.', 'yoast-test-helper' ) );
	}
	...
	public function yoast_seo_premium_upgrade_ran() {
		$this->add_notification( \__( 'Yoast SEO Premium updated its version number, which should mean the upgrade routine was executed.', 'yoast-test-helper' ) );
	}
